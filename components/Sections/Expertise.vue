    ...
    <div class="expertise__container">
      <h2 class="expertise__title">
        <span
          ...
          :key="index"
          class="expertise__title__letter"
          >{{ letter }}</span
        >
      </h2>
...
const cards = [
  {
    ...
    description:
      'Domínio em VueJS, NuxtJS, jQuery, HTML, CSS<br>Especialista em SASS, Bootstrap 5, LESS'
  },
  {
    icon: 'iconoir:tools',
    title: 'Build Tools',
    description:
      'Proficiência em Gulp, Grunt, Parcel<br>Experiência com Babel, Git'
  },
  {
    icon: 'nonicons:javascript-16',
    title: 'JavaScript Ecosystem',
    description:
      'Especialista em JavaScript, TypeScript<br>Experiência com NodeJS'
  },
  {
    icon: 'proicons:webpack',
    title: 'Web Development',
    description:
      'Profundo conhecimento em stack web moderna<br>Habilidade excepcional em SPAs e design responsivo<br>Apaixonado por criar experiências de UI/UX incríveis'
  },
  {
    icon: 'streamline:interface-lighting-light-bulb-lighting-light-incandescent-bulb-lights',
    title: 'Technical Skills',
    description:
      'Domínio em paradigmas Funcionais & OOP<br>Soluções multiplataforma robustas<br>Integração de API eficiente'
  }
];
